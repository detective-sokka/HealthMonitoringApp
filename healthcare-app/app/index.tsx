  ...
  return (
    <ScrollView className="flex-1 bg-gray-100">
      <View className="flex-1 items-center justify-center p-8 bg-blue-500">
        <Text className="text-2xl font-bold text-white mb-4">Hello, Health Care App!</Text>
      ...
      <View className="p-6">
        <View className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <Text className="text-gray-800 text-lg font-semibold">Card Section</Text>
        ...
        <View className="flex-row justify-around my-4">
          <Button title="Primary Action" color="#1E40AF" />
          <Button title="Secondary Action" color="#4ADE80" />
        </View>
